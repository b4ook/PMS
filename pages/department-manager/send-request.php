    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="  background: linear-gradient(45deg,rgba(91, 14, 214, 0.9),rgba(29, 236, 197, 0.9)100%);">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="text-center d-none d-md-inline"  style="margin-left:-20px;">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Send Request <i class="fas fa-paper-plane"></i></h1>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <h5 class="card-title" style="margin-top: 20px;margin-bottom:40px;"><b>Item Request Form <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Fill the form below to send a request"></i></b></h5>
                                <a class="btn btn-danger" href="department-manager-dashboard.php" role="button" style="margin-left:800px;margin-bottom:10px;margin-top:-150px;">Back</a>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-sm-4 col-form-label">Required Date <label style="color:red;">*</label></label>
                                            <div class="col-sm-7">
