                ...
                <div class="container-fluid">
                   ...
                   <!--Contenet goes here -->
                     ...
                     <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Item return <i class="fas fa-undo-alt"></i></h1>
                   ...
                   <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <h5 class="card-title" style="margin-top: 20px;margin-bottom:40px;"><b>Item Return Form <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Fill the form below to return an item"></i></b></h5>
                                <a class="btn btn-danger" href="employee-dashboard.php" role="button" style="margin-left:800px;margin-bottom:10px;margin-top:-150px;">Back</a>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-sm-4 col-form-label">Department <label style="color:red;">*</label></label>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-sm-4 col-form-label">Recieved Date <label style="color:red;">*</label></label>
                                            <div class="col-sm-7">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-sm-4 col-form-label">Remark <label style="color:red;">*</label></label>
                                            <div class="col-sm-9" style="margin-left:-60px;">
                                                <textarea class="form-control" id="" cols="41" rows="5" placeholder="Remark" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
