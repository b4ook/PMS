            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Purchase Request <i class="far fa-paper-plane"></i></h1>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <h5 class="card-title" style="margin-top: 20px;margin-bottom:40px;"><b>Item Purchase Request Form <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Fill the form below to send a purchse request"></i></b></h5>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            <label for="text" class="col-sm-4 col-form-label">Requested By</label></label>
                                            <div class="col-sm-7">
                                                <input class="form-control" type="text" placeholder="Requested By">
                                            </div>
                                        </div>
                                        <div class="form-group row">
